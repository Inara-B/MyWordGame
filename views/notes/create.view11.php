...
color: #BB4A47;
    ...
    body {
      background-image: url(https://images.unsplash.com/photo-1712925371825-78e9f8592208?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGFzdGVsJTIwZmxvd2Vyc3xlbnwwfHwwfHx8MA%3D%3D);   min-height: 100vh;
      margin: 0;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create11" style="display: flex; flex-direction: column; gap: 1rem;">
...
$(document).ready(function(){
  ...
  <img style="position: absolute; top: 1rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/flower.png" width="400">
