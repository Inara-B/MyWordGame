...
color: #BB4A47;
    ...
    body {
      background-image: url(https://img.freepik.com/premium-vector/abstract-technology-binary-code-red-background-with-numbers_158941-159.jpg);
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create4" style="display: flex; flex-direction: column; gap: 1rem;">
...
<img style="position: absolute; top: 23rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/php.png" width="400">
</body>
</html>
