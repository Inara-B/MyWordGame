...
color: #BB4A47;
    ...
    body {
      background-image: url(https://img.freepik.com/premium-vector/cute-animals-vector-illustration_679124-53.jpg?semt=ais_hybrid&w=740);
      min-height: 100vh;
      margin: 0;
      font-family: 'Segoe UI', sans-serif;
    }
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create2" style="display: flex; flex-direction: column; gap: 1rem;">
      ...
      <li class="dropdown-submenu">
        <a class="test" style="color: #BB4A47;">Hint 1 <span class="caret"></span></a>
         ...
         <a class="test" style="color: #BB4A47;">Hint 3 <span class="caret"></span></a>
          <ul class="dropdown-menu">
          <li>Can be found in dense forests, grasslands, and mangrove swamps</li>
          </ul>
...
<img style="position: absolute; top: 23rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/cat.png" width="500">
</body>
</html>
