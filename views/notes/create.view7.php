...
color: #BB4A47;
    ...
    body {
      background-image: url(https://media.gettyimages.com/id/1397892877/video/beautiful-particles-with-shallow-depth-of-field-loopable-blue-version-abstract-background.jpg?s=640x640&k=20&c=mPjvGXBztTXuD7-oxiNFBejvEiag72Rr-vci2zuBEp4=);
      min-height: 100vh;
      margin: 0;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create7" style="display: flex; flex-direction: column; gap: 1rem;">
...
<img style="position: absolute; top: 21rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/shells.png" width="480">
</body>
</html>
