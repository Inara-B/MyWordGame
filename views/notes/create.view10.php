...
color: #BB4A47;
    ...
    body {
      background-image: url(https://static.vecteezy.com/system/resources/thumbnails/042/195/725/small_2x/ai-generated-rainy-sky-background-free-photo.jpg);
    min-height: 100vh;
      margin: 0;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create10" style="display: flex; flex-direction: column; gap: 1rem;">
...
$(document).ready(function(){
  ...
  <img style="position: absolute; top: -1rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/sun.png" width="500">
