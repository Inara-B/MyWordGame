...
color: #BB4A47;
    ...
    body {
      background-image: url(https://img.freepik.com/premium-vector/flat-geometric-shapes-background_23-2148380467.jpg);
      min-height: 100vh;
      margin: 0;
      font-family: 'Segoe UI', sans-serif;
...
<body>
  ...
  <div class="center-content">
    <div class="form-container">
      <form method="POST" action="/notes/create9" style="display: flex; flex-direction: column; gap: 1rem;">
...
<img style="position: absolute; top: 18rem; right: 5rem;" src="https://200c9cdc-4618-4763-b52b-d750b95d230a-00-1c8vy51b6y04r.picard.replit.dev/shape.png" width="450">
</body>
</html>
